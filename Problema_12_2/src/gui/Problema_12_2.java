...
public class Problema_12_2 extends JFrame implements ActionListener {
	...
	protected void actionPerformedBtnProcesar(ActionEvent arg0) {
		//Licencia(String clase, String categoria, String fechaEmision,String fechaRenovacion)
		Licencia li = new Licencia("1","5","14/10/23","14/11/23");
		listar(li);
		Particular pa = new Particular("2","5","13/10/23","13/11/23",45876589);
		listar(pa);
		Profesional pr = new Profesional("3","6","12/10/23","12/11/23","2165495");
		listar(pr);
	}
	
	void listar(Licencia l) {
		if(l instanceof Particular) {
			imprimir("///Particular///");
		}else if(l instanceof Profesional) {
			imprimir("///Profesional///");
		}else {
			imprimir("///Licencia///");
		}
		imprimir(l.datosCompletos());
		imprimir("");
	}
